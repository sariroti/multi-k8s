...
kubectl set image deployments/client-deployment client=sariroti/docker-react-multicontainer-client:$SHA
kubectl set image deployments/worker-deployment worker=sariroti/docker-react-multicontainer-worker:$SHA
